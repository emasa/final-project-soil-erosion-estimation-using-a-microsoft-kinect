...
Los objetivos básicos para el estudio de este modelo físico, de interés para el presente trabajo, son los siguientes:
\begin{itemize}
...
% \begin{figure}[ht]
% \centering\includegraphics[width=\imsize]
% {fosos_erosion_Q900_dem}
% \caption[MDE Ensayo 1]
% {Ensayo 1. Foso de erosión aguas abajo del dique móvil. Modelo digital de elevaciones (MDE).}
% \label{fig:fosos_erosion_Q900_dem}
% \end{figure}
